package ru.geekbraines.spring.winter.market.auth.controllers;
...
import ru.geekbraines.spring.winter.market.api.JwtResponse;
import ru.geekbraines.spring.winter.market.auth.services.UserService;
import ru.geekbraines.spring.winter.market.auth.utils.JwtTokenUtil;
...
//     //  3 бина для аутентификации: 
    ...
    public ResponseEntity<?> createAuthToken(@RequestBody ru.geekbraines.spring.winter.market.api.JwtRequest authRequest) {
        try {
