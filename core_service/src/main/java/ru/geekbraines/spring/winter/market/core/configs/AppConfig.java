...
import ru.geekbraines.spring.winter.market.core.properties.CartServiceIntegrationProperties;
...
public class AppConfig {
  ...
  // private String url; // имплементировали из ямл файла. 
    ...
    private final CartServiceIntegrationProperties cartServiceIntegrationProperties; // это второй вариант, без @Value
